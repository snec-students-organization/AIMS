        ...
        <div class="text-center mb-10">
            <a href="/" class="inline-block group">
                <img src="{{ asset('images/Logo.png') }}" alt="GEMS Logo" 
                    class="h-28 w-auto mb-4 transition-all duration-500 group-hover:scale-105"
                    style="image-rendering: -webkit-optimize-contrast; image-rendering: crisp-edges; filter: contrast(1.1) brightness(1.1);">
            </a>
        </div>
